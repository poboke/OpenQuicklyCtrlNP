...
@class DVTBorderedView, DVTSearchField, IDEOpenQuicklyQuery, IDEOpenQuicklyTableView, IDEWorkspaceTabController, NSArray, NSArrayController, NSImageView, NSMutableArray, NSString;
...
@interface IDEOpenQuicklyWindowController : NSWindowController
{
